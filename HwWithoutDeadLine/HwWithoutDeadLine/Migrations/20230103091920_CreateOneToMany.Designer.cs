...
namespace HwWithoutDeadLine.Migrations
{
    ...
    [Migration("20230103091920_CreateOneToMany")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HwWithoutDeadLine.Models.Department", b =>
                {
                    ...
                    b.Property<Guid?>("SupporSpecialistID")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("HwWithoutDeadLine.Models.SupporSpecialist", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("SupporSpecialistID")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("HwWithoutDeadLine.Models.Department", b =>
                {
                    b.HasOne("HwWithoutDeadLine.Models.SupporSpecialist", null)
                        .WithMany("Department")
                        .HasForeignKey("SupporSpecialistID");
                });
